    ...
    <div className={`relative flex items-center justify-center ${className}`}>
      <div className="animate-float">
        ...
        <img
          ...
          width={720}
          height={550}
          className="w-full max-w-[400px] object-contain sm:max-w-[420px] lg:max-w-[580px] xl:max-w-[680px]"
        />
      </div>
    </div>
  );
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16">
          <div className="flex w-full flex-1 flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div className="relative -mx-6 my-8 w-[calc(100%+3rem)] space-y-4 lg:hidden">
              <ArtCarousel images={GALLERY_IMAGES} direction="left" />
              <ArtCarousel
                images={GALLERY_IMAGES_ROW2}
                direction="right"
          ...
          <div className="hidden w-full flex-1 lg:flex lg:items-center lg:justify-center">
            <HeroMockup />
          </div>
        </div>
